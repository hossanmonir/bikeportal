...
if(isset($_REQUEST["id"])){
	$ar=getBikeFromDB("SELECT * FROM brand where id='".$_REQUEST["id"]."'");
...
?>
		...
		<div class="top1">
			<div class="container_12">
				<div class="grid_12">
					<h2 class="tag"><b>BRAND Information</b></h2>
				</div>
			</div>
		</div>
		...
		<div class="container_12">
			...
			<form name="myForm" action="updateBrand.php" method="post">	
	<table>
		<tr>
			<td class="last">Brand ID</td><td class="last"><input type="text" name="brandid" value="<?php echo $v["id"];?>"</td>
		</tr>
		<tr>
			<td class="last">Name</td><td class="last"><input type="text" name="bname" value="<?php echo $v["name"];?>"</td>
		</tr>
		<tr>
			<td class="last">STATUS</td><td class="last"><input type="text" name="br_status" value="<?php echo $v["status"];?>"</td>
		</tr>
		<tr>
