...
$ar=getBikeFromDB("select * from parts where status = '0' ");
...
?>
		...
		<div class="top1">
			<div class="container_12">
				<div class="grid_12">
					<h2 class="tag"><b>Find Your Desirable Accessories Here</b></h2>
				</div>
			</div>
		</div>
		...
		<?php foreach($jsn as $v){ ?>
			<div class="grid_4">
				<figure><img src="<?php echo $v["imgurl"];?>" alt="accessories"/>
					<figcaption>
